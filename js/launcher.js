...
(function () {
    function init() {
        var router = new Router([
            ...
            new Route('rice_gaps', 'rice_gaps.html'),
            new Route('gnut_gaps', 'gnut_gaps.html'),
            new Route('sorhum_gaps', 'sorhum_gaps.html'),
            new Route('tomatoes_gaps', 'tomatoes_gaps.html'),
            new Route('soy_gaps', 'soy_gaps.html'),
            new Route('sesame_gaps', 'sesame_gaps.html'),
